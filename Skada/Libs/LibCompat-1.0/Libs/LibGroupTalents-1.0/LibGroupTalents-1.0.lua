...
function lib:UNIT_AURA(unit)
	-- Netic fix (#116): UNIT_AURA may fire with a unit token that no
	-- longer resolves (post-arena/BG, transitional roster). UnitGUID
	-- throws "Usage: UnitGUID(\"unit\")" when called with nil/invalid.
